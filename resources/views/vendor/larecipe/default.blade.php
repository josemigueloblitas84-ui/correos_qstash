...
<html>
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="{{ global_asset('vendor/binarytorch/larecipe/assets/css/app.css') }}">

        @if (config('larecipe.ui.fav'))
            <!-- Favicon -->
            <link rel="apple-touch-icon" href="{{ global_asset(config('larecipe.ui.fav')) }}">
            <link rel="shortcut icon" type="image/png" href="{{ global_asset(config('larecipe.ui.fav')) }}"/>
        @endif

        <!-- FontAwesome -->
        <link rel="stylesheet" href="{{ global_asset('vendor/binarytorch/larecipe/assets/css/font-awesome.css') }}">
        @if (config('larecipe.ui.fa_v4_shims', true))
            <link rel="stylesheet" href="{{ global_asset('vendor/binarytorch/larecipe/assets/css/font-awesome-v4-shims.css') }}">
        @endif
    ...
    <body>
        ...
        <script src="{{ global_asset('vendor/binarytorch/larecipe/assets/js/app.js') }}"></script>
